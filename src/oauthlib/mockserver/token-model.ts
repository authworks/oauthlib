import { MILLISECONDS_PER_SECOND } from '../oauth2/constants';
import { InvalidArgumentError } from '../oauth2/errors';
import { Client, Token, User } from '../oauth2/spi';
import { hasOwnProperty } from '../oauth2/utils/fn';
